...
Start-Process cmd -ArgumentList "/c title Backend Java & cd `"C:\Users\RyZe_\Downloads\Project-Sena-Web-Store-Textil`" & color 0a & echo === BACKEND JAVA === & set DB_PASSWORD=Mp.1025889078& java -cp `"bin;lib/*`" App & pause"

Write-Host "Iniciando servidor Frontend de React (Se abrira en otra ventana)..."
Start-Process cmd -ArgumentList "/c title Frontend React & cd `"C:\Users\RyZe_\Downloads\Project-Sena-Web-Store-Textil`" & color 0b & echo === FRONTEND VITE === & npm run dev & pause"
